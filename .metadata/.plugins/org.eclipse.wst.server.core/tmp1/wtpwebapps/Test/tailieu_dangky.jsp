...
<body>
    <div class="bg-white w-[400px] shadow-lg mx-auto px-[40px] pb-5">
        <h1 class="text-center !text-[22px] py-2 font-semibold">Tạo tài khoản</h1>
        ...
        <form action="" class="mt-2">
            <div class="mb-2">
                <input type="text" required class="form-control" id="" placeholder="Họ và tên*">
            </div>
            <div class="mb-2">
                <input type="text" required class="form-control" id="" placeholder="Tài khoản*">
            </div>
            <div class="mb-2">
